...
chrome.storage.local.get(['currentURL'], function(result) {
    ...
    if (browserUsed === 'chrome') {
        if (result.currentURL.url.indexOf('chrome://extensions/') === -1) {
            ...
            let popupPrefixSpecific = document.getElementById('defineItBody-specificBlacklist');
            let popupPrefixDomain = document.getElementById('defineItBody-domainBlacklist');
            let siteSpecificEl = document.getElementById('defineItBody-blacklist-site-specific');
            let siteEntireEl = document.getElementById('defineItBody-blacklist-site-entire');
            ...
            function refreshPopup() {
                document.getElementById('defineIt-refreshIcon').src = 'chrome-extension://oggcbcimbjpahiohkgphecjjaedgfbhm/icons/256.png';
                document.getElementById('defineIt-container-id').style.display = 'none';
                document.getElementById('defineIt-refreshIconContainer').style.display = 'flex';
                document.getElementById('defineIt-refreshButtonID').addEventListener('click', function() {
                    //console.log('clicked');
        ...
        if (result.currentURL.url.indexOf('moz-extension://') === -1) {
            currentURL = result;
            //console.log(currentURL.currentURL.url);
            ...
            function refreshPopup() {
                ...
                document.getElementById('defineIt-refreshIcon').src = manifestUrl;
                document.getElementById('defineIt-container-id').style.display = 'none';
                document.getElementById('defineIt-refreshIconContainer').style.display = 'flex';
                document.getElementById('defineIt-refreshButtonID').addEventListener('click', function() {
                    //console.log('clicked');
